...
func postEstate(c echo.Context) error {
	...
	for _, row := range records {
		...
		_, err := tx.Exec("INSERT INTO estate(id, name, description, thumbnail, address, latitude, longitude, geom, rent, door_height, door_width, features, popularity) VALUES(?,?,?,?,?,?,?,POINT(?,?),?,?,?,?,?)", id, name, description, thumbnail, address, latitude, longitude, latitude, longitude, rent, doorHeight, doorWidth, features, popularity)
		if err != nil {
